...
const AboutUs = () => {
    return (
        <div className="container mx-auto mb-10">
            ...
            <div className="md:w-2/3 w-full mx-auto px-3 text-justify">
                ...
                <img className="my-4 w-full rounded-lg" src='https://i.ibb.co/5x252Qp/Somalia.jpg' alt="" />
                ...
                <img className="my-4 w-full rounded-lg" src='https://i.ibb.co/rp02hWD/syria.jpg' alt="" />
                ...
                <img className="my-4 w-full rounded-lg" src='https://i.ibb.co/sjQ5F2n/myanmar.jpg' alt="" />
                ...
                <img className="my-4 w-full rounded-lg" src='https://i.ibb.co/wycfY8j/venezuelan.jpg' alt="" />
